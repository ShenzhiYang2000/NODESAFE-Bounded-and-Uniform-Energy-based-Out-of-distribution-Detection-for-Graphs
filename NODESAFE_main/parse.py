...
def parser_add_main_args(parser):
    ...
    # model network
    parser.add_argument('--method', type=str, default='gnnsafe', choices=['msp', 'nodesafe'])
    ...
    parser.add_argument('--alpha', type=float, default=1.0, help='weight for regularization')
    ...
    parser.add_argument('--eta', type=float, default=0.5, help='weight for residual connection in propagation') #0.5
    parser.add_argument('--lamda1', type=float, default=0.999, help='weight for bounded loss and uniform loss')
    parser.add_argument('--lamda2', type=float, default=1.0, help='weight for mloss')
